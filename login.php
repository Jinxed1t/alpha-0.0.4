...
// <![CDATA[
    ...
    frmvalidator.addValidation("username","req","Gelieve een gebruikersnaam in te geven!");
    
    frmvalidator.addValidation("password","req","Gelieve een gebruikersnaam in te geven!");
